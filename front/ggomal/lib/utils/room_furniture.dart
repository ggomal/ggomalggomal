...
class _FurnitureDialogState extends State<FurnitureDialog> {
  ...
  Widget showPurchaseDialog2(BuildContext context, int index, int count){
                ...
                children: [
                  Container(
                    child: ElevatedButton(
                      onPressed: (){
                        Provider.of<FurnitureState>(context, listen: false).unlockItem(index);
                          ...
                          return InkWell(
                            onTap: () {
                              showDialog(context: context, builder: (builder){
                                return showPurchaseDialog2(context, index, item['count']);
                              });
                            },
                            child: Container(
