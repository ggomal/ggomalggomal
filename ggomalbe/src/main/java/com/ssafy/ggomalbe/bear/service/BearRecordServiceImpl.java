...
public class BearRecordServiceImpl implements BearRecordService {
    ...
    @Override
    public Mono<BearRecordResponse> addBearRecordV2(FilePart filePart, Long memberId, Long gameNum, Long wordId, String letter, Short pronCount) {
        return evaluationService.evaluationV2(filePart, letter)
                .flatMap((evaluateResult) -> {
